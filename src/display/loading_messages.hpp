...
#ifndef MOTRIX_DISPLAY_LOADING_MESSAGES_HPP
#define MOTRIX_DISPLAY_LOADING_MESSAGES_HPP

#include <array>

namespace display
{
  constexpr const std::array<const char*, 106> all_messages
    {{
...
#endif // MOTRIX_DISPLAY_LOADING_MESSAGES_HPP
